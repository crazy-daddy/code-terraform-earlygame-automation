...
Scripts that automate the early-game bootstrap of a fresh [Code: Terraform](https://store.steampowered.com/) save: First Contact onboarding, the 3 intro Earth contracts, and building out/scaling the base all the way to the 150,000 TP mid-game transition.
